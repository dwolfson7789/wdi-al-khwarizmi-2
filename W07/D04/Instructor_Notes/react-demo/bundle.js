...
/***/ function(module, exports, __webpack_require__) {
	...
	/**** Part 3 - Composing Components (these can live in separate files) ***/
	...
	// });
	//
	// // <MyComponent myComponentsData={4} name={'liza'} listData={['a', 'b', 4]}>
	// //
	// // </MyComponent>
	// //
	// // this.props = {
	...
	//
	//   render: function() {
	//   	var listData = ['Apples', 'Bananas', 'Carrots'];
	//   	var listData2 = ['Cats', 'Dogs'];
	//
	//     return (
	//     	<div className="App">
	//         <HelloMessage listData={listData} />
	//         <MyCustomSection listData={listData} />
	...
	/*** MORE LESSONS ***/
	// Part 7 - Passing callbacks to children from parents through props
	// Part 8 - API Call in a component
