...
1. Box model: draw out on the wall a `<div>` that has some text inside it as it's displayed on the page. It has a 1px solid black border. Indicate the element contents, padding, margin, and border. What's the difference between padding and margin?
